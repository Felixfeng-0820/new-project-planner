...
这个 skill 是给这样的大学生：**看着同学大一大二就自己做出网站和项目，心里又羡慕又憋着一股劲，却不知道从哪下手。**

- 你有没有见过同学晒出自己做的网站，心想：*我也想做——但我根本不知道从哪开始？*
- 你想要的是一个任何人能打开的公开网址，而不是一个只能在自己电脑上打开的本地网页吗？
- 你想跳过那些玩具教程，做一个真正能写进简历的东西吗？

只要你对其中任何一句点了头，这个 skill 就是为你准备的：一句模糊想法进，一个验证过的、可部署的产品出。
...
- 适配自己的真实能力：能跑命令就自主执行；纯聊天里切到引导模式——文件以代码块形式给、命令精确到一条——绝不声称跑过它跑不了的东西
- 处理中断、干净续跑：中途改需求就折进当前阶段或重新排期，绝不悄悄丢掉；新会话读 `PROJECT_NOTES.md` 从上次的地方继续
